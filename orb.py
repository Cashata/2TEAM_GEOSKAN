...
class OrbDetector:
    def __init__(self, map_size_m=(3.0, 3.0)):
        ...
        self.map_kp, self.map_des = self._detect_orb_grid(3, 3)
    ...
    def draw_debug(self, frame):
        ...
        if H is not None:
            ...
            cv2.putText(
                vis,
                f"px: {mapped_px[0]:.1f}, {mapped_px[1]:.1f}",
                (5, 30),
            ...
            cv2.putText(
                vis,
                f"m: {mapped_m[0]:.2f}, {mapped_m[1]:.2f}",
                (5, 55),
                cv2.FONT_HERSHEY_SIMPLEX,
                0.8,
                (0, 0, 0),
...
if __name__ == '__main__':
    ...
    # out = cv2.VideoWriter('orb.avi', fourcc, fps, (width, height))
    #
    # for i in range(10):
    ...
    #         break
    #
    #     # out.write(detector.draw_debug(frame))
